...
const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'deployment-plans', name: 'deployment-plans', component: () => import('@/views/DevOpsView.vue'), props: { section: 'deployment-plans' }, meta: { title: 'nav.deploymentPlans', permissions: ['delivery.read'] } },
      ...
      { path: 'infrastructure', name: 'infrastructure', component: () => import('@/views/InfrastructureView.vue'), meta: { title: 'nav.containers', permissions: ['cluster.read', 'terminal.open'] } },
      ...
      { path: 'logs', name: 'logs', component: () => import('@/views/LogsView.vue'), meta: { title: 'nav.logs', permissions: ['delivery.read'] } },
  ...
  { path: '/release-workflows', redirect: '/pipeline-plans' },
  { path: '/release-workflows/editor', redirect: '/pipeline-plans/editor' },
