...
type IconName = 'home' | 'app' | 'git' | 'build' | 'registry' | 'release' | 'pipeline' | 'cloud' | 'ops' | 'shield'
...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '身份与审计', path: '/access', permissions: ['user.read', 'role.read', 'audit.read'], icon: 'shield' as IconName },
