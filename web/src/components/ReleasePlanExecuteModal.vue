...
<style scoped>
.execution-shell{color:var(--edo-text)}
.execution-overview{display:flex;align-items:flex-start;gap:13px;padding:2px 0 16px}.overview-mark{display:grid;width:44px;height:44px;flex:0 0 44px;place-items:center;border-radius:13px;color:var(--edo-primary);background:var(--edo-primary-soft)}.execution-overview>div{min-width:0}.execution-overview small,.execution-overview strong,.execution-overview p{display:block}.execution-overview small{color:var(--edo-primary);font-size:10px;font-weight:650;letter-spacing:.08em}.execution-overview strong{overflow:hidden;margin-top:2px;text-overflow:ellipsis;white-space:nowrap;font-size:18px}.execution-overview p{margin:4px 0 0;color:var(--edo-muted);font-size:12px;line-height:1.5}
