...
<style scoped>
.form-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:0 16px}.span-2{grid-column:1/-1}.form-grid :deep(.ant-input-number){width:100%}.capability-grid{display:grid;width:100%;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.capability-grid.local-capabilities{grid-template-columns:repeat(2,minmax(0,1fr))}.capability-option{display:flex;min-height:82px;align-items:center;padding:10px;border:1px solid var(--zrt-border);border-radius:10px;background:var(--zrt-surface-soft)}.capability-option:has(.ant-checkbox-checked){border-color:color-mix(in srgb,var(--zrt-primary) 55%,var(--zrt-border));background:var(--zrt-primary-soft)}.capability-option :deep(.ant-checkbox){align-self:center}.capability-option>span:last-child{display:flex;align-items:center;gap:8px}.capability-option strong,.capability-option small{display:block}.capability-option small{margin-top:2px;color:var(--zrt-muted);font-size:11px;line-height:1.4}.capability-brand{display:grid;width:34px;height:34px;flex:0 0 34px;place-items:center;border-radius:9px;background:var(--zrt-surface)}.capability-brand :deep(svg){width:21px;height:21px}.capability-brand.ssh,.capability-brand.local_exec{color:var(--zrt-muted)}.capability-brand.docker{color:#2496ed}.capability-brand.kubernetes{color:#326ce5}.credential-toggle{display:flex;align-items:center;justify-content:space-between;padding:12px 14px;border:1px solid var(--zrt-border);border-radius:10px;background:var(--zrt-surface-soft)}.credential-toggle>div strong,.credential-toggle>div small{display:block}.credential-toggle>div small{margin-top:2px;color:var(--zrt-muted);font-size:12px}.field-hint{margin-top:6px;color:var(--zrt-muted);font-size:12px}.test-result{margin-top:8px}.test-details{display:flex;flex-wrap:wrap;gap:8px 14px}.test-details code{width:100%;overflow-wrap:anywhere;color:var(--zrt-muted)}.drawer-actions{display:flex;justify-content:flex-end;gap:8px}@media(max-width:640px){.form-grid,.capability-grid,.capability-grid.local-capabilities{grid-template-columns:1fr}.span-2{grid-column:auto}}
