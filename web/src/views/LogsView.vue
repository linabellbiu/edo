...
<style scoped>
.scope-alert { margin-bottom: 12px; }.log-filter { display: grid; grid-template-columns: minmax(240px,1fr) 160px auto; gap: 10px; margin-bottom: 14px; padding: 12px; }.log-list { overflow: hidden; }.log-list > .ant-empty { padding: 70px 20px; }.log-item { padding: 16px 18px; border-left: 3px solid #79a8ff; border-bottom: 1px solid var(--zrt-border); }.log-item.level-error { border-left-color:#ef5656; }.log-item.level-warn { border-left-color:#efaa3a; }.log-item.level-debug { border-left-color:#9aa4b2; }.log-item header { display: flex; align-items: center; gap: 9px; color: var(--zrt-muted); }.log-item header strong { color: var(--zrt-text); }.log-item time { margin-left: auto; font-size: 12px; }.log-item pre { margin: 12px 0; overflow: auto; color: var(--zrt-text); white-space: pre-wrap; word-break: break-word; }.log-item footer { display: flex; flex-wrap: wrap; gap: 7px; color: var(--zrt-muted); font-size: 12px; }.log-item footer span { display: inline-flex; align-items: center; overflow: hidden; border: 1px solid var(--zrt-border); border-radius: 5px; background: var(--zrt-layout); }.log-item footer b { padding: 3px 6px; border-right: 1px solid var(--zrt-border); font-weight: 500; }.log-item footer code { max-width: min(520px,70vw); padding: 3px 6px; overflow: hidden; color: var(--zrt-text); text-overflow: ellipsis; white-space: nowrap; }.load-more { display: flex; justify-content: center; padding: 16px; } @media (max-width:700px){.log-filter{grid-template-columns:1fr}.log-item header{flex-wrap:wrap}.log-item time{width:100%;margin:0}}
</style>
