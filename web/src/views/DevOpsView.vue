...
.image-path-preview{display:block;overflow-wrap:anywhere;color:var(--zrt-text);font-size:12px}.image-path-alert .field-hint{line-height:1.55}
...
.application-links{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.application-links>button{display:grid;grid-template-columns:minmax(0,1fr) 14px;min-width:0;padding:10px 10px 10px 11px;border:1px solid transparent;border-radius:9px;color:var(--zrt-text);background:var(--zrt-surface-soft);cursor:pointer;text-align:left;transition:transform 160ms ease,border-color 160ms ease,background 160ms ease}.application-links>button:hover{transform:translateY(-1px);border-color:color-mix(in srgb,var(--zrt-primary) 28%,var(--zrt-border));background:color-mix(in srgb,var(--zrt-primary) 5%,var(--zrt-surface))}.application-links>button:focus-visible{outline:2px solid color-mix(in srgb,var(--zrt-primary) 48%,transparent);outline-offset:2px}.application-links button>span{display:flex;min-width:0;align-items:center;gap:5px;color:var(--zrt-muted);font-size:11px}.application-links button>span svg{width:13px}.application-links button>strong{overflow:hidden;margin-top:4px;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.application-links button>svg{grid-area:1/2/3/3;width:14px;align-self:center;color:var(--zrt-muted);transition:transform 160ms ease}.application-links>button:hover>svg{transform:translateX(2px);color:var(--zrt-primary)}.application-footer{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-top:14px;padding-top:14px;border-top:1px solid var(--zrt-border)}.application-sync{display:flex;min-width:0;align-items:center;gap:8px;color:#9ba1ad}.application-sync.tone-info{color:#4f7df3}.application-sync.tone-success{color:#2ab573}.application-sync.tone-warning{color:#dfa126}.application-sync.tone-danger{color:#ed5965}.application-sync time{margin-left:4px;color:var(--zrt-muted);font-size:11px;white-space:nowrap}.application-actions{display:flex;flex:0 0 auto;gap:7px}.application-actions :deep(.ant-btn){display:inline-flex;align-items:center;gap:5px}.application-actions svg{width:14px}.application-detail-toggle svg{transition:transform 180ms ease}.application-detail-toggle svg.expanded{transform:rotate(180deg)}.application-details{margin-top:13px;padding-top:13px;border-top:1px solid var(--zrt-border)}.application-details-enter-active,.application-details-leave-active{transform-origin:top;transition:opacity 160ms ease,transform 180ms cubic-bezier(.2,0,0,1)}.application-details-enter-from,.application-details-leave-to{opacity:0;transform:translateY(-5px)}
.application-links.single{grid-template-columns:1fr}.application-resource-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;margin-top:9px}.application-resource-panel{min-width:0;padding:11px;border:1px solid var(--zrt-border);border-radius:11px;background:var(--zrt-surface-soft)}.application-resource-panel>header{display:flex;align-items:center;justify-content:space-between;margin-bottom:8px}.application-resource-panel>header>div{display:flex;min-width:0;align-items:center;gap:7px}.application-resource-panel>header svg{width:15px;color:var(--zrt-primary)}.application-resource-panel>header span,.application-resource-panel>header strong,.application-resource-panel>header small{display:block}.application-resource-panel>header strong{font-size:12px}.application-resource-panel>header small{margin-top:1px;color:var(--zrt-muted);font-size:10px}.application-workflow-list,.application-deployment-list{display:grid;max-height:360px;gap:6px;overflow-y:auto;scrollbar-width:thin}.application-workflow-list>button{display:grid;width:100%;min-width:0;align-items:center;grid-template-columns:30px minmax(0,1fr) auto 13px;gap:8px;padding:8px;border:1px solid transparent;border-radius:9px;color:var(--zrt-text);background:var(--zrt-surface);cursor:pointer;text-align:left;transition:border-color 160ms ease,transform 160ms ease}.application-workflow-list>button:hover{transform:translateY(-1px);border-color:color-mix(in srgb,var(--zrt-primary) 28%,var(--zrt-border))}.application-workflow-list>button:focus-visible{outline:2px solid color-mix(in srgb,var(--zrt-primary) 48%,transparent);outline-offset:1px}.application-workflow-list>button>svg{width:13px;color:var(--zrt-muted)}.application-workflow-icon,.application-deployment-icon{display:grid;width:30px;height:30px;place-items:center;border-radius:8px;color:var(--zrt-primary);background:var(--zrt-primary-soft)}.application-workflow-icon svg,.application-deployment-icon svg{width:15px}.application-workflow-copy{min-width:0}.application-workflow-copy>span{display:flex;min-width:0;align-items:center;gap:6px}.application-workflow-copy strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}.application-workflow-copy i{padding:1px 5px;border-radius:999px;color:#168b57;background:color-mix(in srgb,#2ab573 11%,var(--zrt-surface));font-size:9px;font-style:normal;white-space:nowrap}.application-workflow-copy i.inactive{color:var(--zrt-muted);background:var(--zrt-surface-soft)}.application-workflow-copy small{display:block;overflow:hidden;margin-top:2px;color:var(--zrt-muted);font-size:10px;text-overflow:ellipsis;white-space:nowrap}.application-workflow-run,.application-deployment-state{display:grid;min-width:70px;grid-template-columns:7px auto;align-items:center;column-gap:5px;color:#949aa5}.application-workflow-run>i,.application-deployment-state>i{width:6px;height:6px;border-radius:50%;background:currentColor}.application-workflow-run strong,.application-deployment-state strong{font-size:10px;white-space:nowrap}.application-workflow-run time,.application-deployment-state time{grid-column:1/-1;margin-top:2px;color:var(--zrt-muted);font-size:9px;white-space:nowrap}.application-workflow-run.tone-info,.application-deployment-state.tone-info{color:#4f7df3}.application-workflow-run.tone-success,.application-deployment-state.tone-success{color:#2ab573}.application-workflow-run.tone-warning,.application-deployment-state.tone-warning{color:#dfa126}.application-workflow-run.tone-danger,.application-deployment-state.tone-danger{color:#ed5965}.application-workflow-run.is-live>i,.application-deployment-state.is-live>i{animation:application-pulse 2s ease-out infinite}.application-deployment-item{min-width:0;overflow:hidden;border-radius:9px;background:var(--zrt-surface)}.application-deployment-summary{display:grid;width:100%;min-width:0;align-items:center;grid-template-columns:30px minmax(0,1fr) auto 14px;gap:8px;padding:8px;border:0;color:var(--zrt-text);background:transparent;cursor:pointer;text-align:left}.application-deployment-summary:hover{background:color-mix(in srgb,var(--zrt-primary) 4%,var(--zrt-surface))}.application-deployment-summary:focus-visible{outline:2px solid color-mix(in srgb,var(--zrt-primary) 45%,transparent);outline-offset:-2px}.application-deployment-summary>svg{width:14px;color:var(--zrt-muted);transition:transform 180ms ease}.application-deployment-summary>svg.expanded{transform:rotate(180deg)}.application-deployment-icon.kind-compose{color:#1677ff;background:color-mix(in srgb,#1677ff 10%,var(--zrt-surface))}.application-deployment-icon.kind-kubernetes{color:#326ce5;background:color-mix(in srgb,#326ce5 10%,var(--zrt-surface))}.application-deployment-icon.kind-script{color:#596273;background:color-mix(in srgb,#596273 10%,var(--zrt-surface))}.application-deployment-copy{min-width:0}.application-deployment-copy strong,.application-deployment-copy small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.application-deployment-copy strong{font-size:12px}.application-deployment-copy small{margin-top:2px;color:var(--zrt-muted);font-size:10px}.application-deployment-details{padding:0 9px 9px 47px}.application-deployment-details dl{display:grid;gap:5px;margin:0;padding:8px 9px;border-radius:8px;background:var(--zrt-surface-soft)}.application-deployment-details dl>div{display:grid;min-width:0;grid-template-columns:62px minmax(0,1fr);gap:8px}.application-deployment-details dt{color:var(--zrt-muted);font-size:10px}.application-deployment-details dd{overflow:hidden;margin:0;text-overflow:ellipsis;white-space:nowrap;font-size:10px}.application-deployment-actions{display:flex;justify-content:flex-end;gap:6px;margin-top:7px}.application-deployment-actions :deep(.ant-btn){display:inline-flex;align-items:center;gap:4px}.application-deployment-actions svg{width:13px}.deployment-details-enter-active,.deployment-details-leave-active{transition:opacity 140ms ease,transform 160ms ease}.deployment-details-enter-from,.deployment-details-leave-to{opacity:0;transform:translateY(-3px)}.application-resource-empty{display:grid;min-height:46px;margin:0;place-items:center;color:var(--zrt-muted);font-size:11px}
