...
<style scoped>
.infra-workspace{display:grid;min-height:610px;grid-template-columns:292px minmax(0,1fr);overflow:hidden}.resource-tree-panel{min-width:0;border-right:1px solid var(--edo-border);background:color-mix(in srgb,var(--edo-surface-soft) 82%,var(--edo-surface))}.resource-tree-header{display:flex;min-height:64px;align-items:center;justify-content:space-between;padding:0 16px}.resource-tree-header strong,.resource-tree-header small{display:block}.resource-tree-header small{margin-top:1px;color:var(--edo-muted);font-size:12px}.resource-tree-header>span{min-width:28px;padding:3px 8px;border:1px solid var(--edo-border);border-radius:999px;color:var(--edo-muted);background:var(--edo-surface);text-align:center;font-size:12px}.resource-tree{padding:8px}.resource-tree button{outline:0}.resource-tree button:focus-visible{box-shadow:inset 0 0 0 2px color-mix(in srgb,var(--edo-primary) 44%,transparent)}.overview-node,.host-toggle,.host-capabilities button{display:grid;width:100%;align-items:center;border:0;background:transparent;cursor:pointer;text-align:left}.overview-node{min-height:52px;grid-template-columns:36px minmax(0,1fr) 16px;gap:10px;padding:7px 9px;border-radius:10px}.overview-node:hover,.overview-node.active{background:var(--edo-surface)}.overview-node.active{box-shadow:0 2px 8px rgb(30 45 75 / 5%)}.overview-icon,.host-icon,.runtime-icon{display:grid;place-items:center;border-radius:9px;background:var(--edo-surface)}.overview-icon{width:34px;height:34px;color:var(--edo-primary);background:var(--edo-primary-soft)}.overview-icon svg{width:17px}.overview-node>span:nth-child(2),.host-copy,.host-capabilities button>span:nth-child(2){min-width:0}.overview-node strong,.overview-node small,.host-copy strong,.host-copy small,.host-capabilities strong,.host-capabilities small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.overview-node strong,.host-copy strong,.host-capabilities strong{font-size:13px;font-weight:600}.overview-node small,.host-copy small,.host-capabilities small{margin-top:1px;color:var(--edo-muted);font-size:11.5px}.overview-node>svg,.host-toggle>svg,.host-capabilities button>svg{width:14px;color:var(--edo-muted)}.host-branch{margin-top:7px;padding:5px;border:1px solid var(--edo-border);border-radius:11px;background:color-mix(in srgb,var(--edo-surface) 76%,transparent)}.host-branch.active{border-color:color-mix(in srgb,var(--edo-primary) 28%,var(--edo-border));background:var(--edo-surface)}.host-toggle{min-height:50px;grid-template-columns:36px minmax(0,1fr) 16px;gap:10px;padding:7px 8px;border-radius:8px}.host-toggle:hover{background:var(--edo-surface-soft)}.host-icon{width:34px;height:34px;color:var(--edo-primary)}.host-icon.inactive,.host-icon.legacy{color:var(--edo-muted)}.host-icon svg{width:17px}.host-toggle>svg{transition:transform 160ms ease}.host-toggle>svg.collapsed{transform:rotate(-90deg)}.host-capabilities{display:grid;gap:2px;padding:3px 0 1px 44px}.host-capabilities button{position:relative;min-height:47px;grid-template-columns:30px minmax(0,1fr) 14px;gap:8px;padding:5px 7px;border-radius:8px}.host-capabilities button:hover,.host-capabilities button.active{background:var(--edo-primary-soft)}.host-capabilities button.active::before{position:absolute;top:9px;bottom:9px;left:0;width:2px;border-radius:2px;background:var(--edo-primary);content:""}.host-capabilities button.active strong{color:var(--edo-primary)}.host-capabilities button.unavailable{opacity:.72}.runtime-icon{width:28px;height:28px}.runtime-icon :deep(svg){width:18px;height:18px}.runtime-icon.docker{color:#2496ed;background:color-mix(in srgb,#2496ed 10%,var(--edo-surface))}.runtime-icon.kubernetes{color:#326ce5;background:color-mix(in srgb,#326ce5 10%,var(--edo-surface))}.runtime-state{width:7px;height:7px;justify-self:center;border-radius:50%;background:#a8adb7}.runtime-state.ready{background:#25b66f;box-shadow:0 0 0 3px color-mix(in srgb,#25b66f 12%,transparent)}.runtime-state.unavailable{background:#ef5656}.runtime-state.unchecked{background:#d99b25}.legacy-branch{border-style:dashed}.tree-collapse-enter-active,.tree-collapse-leave-active{transition:opacity 140ms ease,transform 160ms ease}.tree-collapse-enter-from,.tree-collapse-leave-to{opacity:0;transform:translateY(-4px)}.infra-workspace>main{min-width:0;padding:22px}.runtime-overview h3,.runtime-overview p{margin:0}.runtime-overview p{margin-top:3px;color:var(--edo-muted)}.overview-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:18px}.overview-grid article{display:flex;min-height:88px;align-items:center;gap:13px;padding:15px;border:1px solid var(--edo-border);border-radius:12px;background:var(--edo-surface-soft)}.overview-grid article>span{display:grid;width:44px;height:44px;place-items:center;border-radius:12px;color:var(--edo-primary);background:var(--edo-surface)}.overview-grid article>span :deep(svg){width:24px;height:24px}.overview-grid article>span.docker{color:#2496ed}.overview-grid article>span.kubernetes{color:#326ce5}.overview-grid small,.overview-grid strong{display:block}.overview-grid small{color:var(--edo-muted)}.overview-grid strong{font-size:23px}.unbound-alert{margin-top:16px}.runtime-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:18px}.runtime-heading h3,.runtime-heading p{margin:0}.runtime-heading h3{margin-top:2px}.runtime-heading p,.runtime-heading span{color:var(--edo-muted)}.runtime-heading>div:last-child{display:flex;gap:8px}@media(max-width:900px){.infra-workspace{grid-template-columns:1fr}.resource-tree-panel{max-height:390px;overflow:auto;border-right:0;border-bottom:1px solid var(--edo-border)}.overview-grid{grid-template-columns:1fr}}@media(max-width:620px){.infra-workspace>main{padding:16px}.runtime-heading{flex-direction:column}}
</style>
