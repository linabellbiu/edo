...
<style scoped>.access-tabs{margin-bottom:12px}.tag-list{display:flex;flex-wrap:wrap;gap:3px}.permission-group,.override-group{margin:16px 0;padding:14px;border:1px solid var(--zrt-border);border-radius:7px}.permission-options{display:grid;grid-template-columns:repeat(2,1fr);gap:9px;margin-top:12px}.permission-options :deep(.ant-checkbox-wrapper){align-items:flex-start}.permission-options span,.permission-options small,.override-row span b,.override-row span small{display:block}.permission-options small,.override-row small{color:var(--zrt-muted);font-size:11px}.override-row{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:10px 0;border-top:1px solid var(--zrt-border)}h3{margin:24px 0 12px}@media(max-width:650px){.permission-options{grid-template-columns:1fr}.override-row{align-items:flex-start;flex-direction:column}}
</style>
