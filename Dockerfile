...
RUN apt-get -o Acquire::Retries=5 update \
    ...
    && chown -R zrt:zrt /app
WORKDIR /app
COPY --from=go-builder --chown=zrt:zrt /out/zrt /app/zrt
COPY --from=web-builder --chown=zrt:zrt /src/web/dist/ /app/web/
ENV ZRT_WEB_ROOT=/app/web \
