...
func NewRouter(deps Dependencies) *gin.Engine {
	...
	protected.POST("/applications/:id/workflows", auditAction(deps.Audits, deps.Logger, "workflow.create", "release_workflow"), requirePermission(deps.Access, deps.Logger, access.PermissionDeliveryManage), pipelineAPI.createWorkflow)
	...
	protected.PUT("/applications/:id/workflows/:workflow_id", auditAction(deps.Audits, deps.Logger, "workflow.update", "release_workflow"), requirePermission(deps.Access, deps.Logger, access.PermissionDeliveryManage), pipelineAPI.saveWorkflow)
	protected.DELETE("/applications/:id/workflows/:workflow_id", auditAction(deps.Audits, deps.Logger, "workflow.delete", "release_workflow"), requirePermission(deps.Access, deps.Logger, access.PermissionDeliveryManage), pipelineAPI.deleteWorkflow)
